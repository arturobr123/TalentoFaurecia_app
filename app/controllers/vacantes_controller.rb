class VacantesController < ApplicationController
  ...
  private
    ...
    def vacante_params
      params.require(:vacante).permit(:name, :area, :location, :little_description, :description, :missions_role, :occupied ,:periodo_de_practica, :Name_Hiring_Manager, :planta,  :job_area_id , :mes_inicio, :mes_fin, :email_hiring_manager )
    end
end
